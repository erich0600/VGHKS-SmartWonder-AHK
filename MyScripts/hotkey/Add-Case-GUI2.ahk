...
AddGUI(){	
	...
	M := 1
	params = 1
	static E2, E3, E4, E5, E6, E7, E8, E9, Modality, C1, C2, C3, C4, Download, Follow
	static objExcel, objWorkBook
	if params = 4
	{
		Gui, Add, Edit, vE2 w70 hwndPID, %PatID%
		SetEditCueBanner(PID, "Patient ID")
		Gui, Add, Edit, YS vE3 w70 hwndAccN,  %AccNo%
		SetEditCueBanner(AccN, "Accesion No.") 
		Gui, Add, Edit, YS vE4 w70 hwndDate,  %ExamDate%
		SetEditCueBanner(Date, "Exam Date")
		Gui, Add, Edit, YS vE5 w70 hwndType r1, %currExamName%
